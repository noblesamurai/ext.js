...
Ext.extend(Array.prototype, {
  ...
  remove: function (obj, fn, context) {
    ...
    return deleted ? this : fn ? fn.call(context) : undefined
  },
  ...
  detect: function (fn, context) {
    ...
    for (var i = 0, len = this.length; i < len; ++i)
      if (fn.call(context, this[i], i, this)) return this[i];
  },
  ...
  map: function(fn, context) {
    ...
    return this.reduce([], function(mapped, val, key){
      mapped.push(fn.call(context, val, key))
      return mapped
    })
  },
  ...
  /**
   * Reject values when _fn_ returns a truthy value.
   *
